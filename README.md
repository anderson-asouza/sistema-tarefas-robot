...
![Preview](fotos/sistemaTarefasRobot.png)
...
## 🎥 Demonstração do Projeto – Robô de Automação Web

> Vídeo narrado apresentando o funcionamento da automação e explicando etapas do processo.

[![Preview](fotos/preview.png)](https://github.com/anderson-asouza/sistema-tarefas-robot/releases/download/v1.0/SistemaTarefasRobot.mp4)
